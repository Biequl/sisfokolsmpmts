	...
	if (empty($filex_namex))
		...
		if ($ext_filex == ".xls")
			...
			for ($i=2; $i<=$baris+5; $i++)
				...
				$qijzx = mysqli_query($koneksi, "SELECT * FROM m_ijazah ".
										"WHERE ijazah = '$i_pddkn_ijazah'");
				$rijzx = mysqli_fetch_assoc($qijzx);
				$i_pddkn_ijazah = balikin($rijzx['kd']);

				$i_pddkn_akta = $data->val($i,18);
				$qaktx = mysqli_query($koneksi, "SELECT * FROM m_akta ".
										"WHERE akta = '$i_pddkn_akta'");
				$raktx = mysqli_fetch_assoc($qaktx);
				...
				$qtup = mysqli_query($koneksi, "SELECT * FROM m_status ".
				...
				$qgol = mysqli_query($koneksi, "SELECT * FROM m_golongan ".
										"WHERE golongan = '$i_kerja_pangkat'");
				$rgol = mysqli_fetch_assoc($qgol);
				$gol_kd = nosql($rgol['kd']);
				$i_kerja_pangkat = $gol_kd;


				$i_kerja_jabatan = $data->val($i,31);
				$qjbtx = mysqli_query($koneksi, "SELECT * FROM m_jabatan ".
										"WHERE jabatan = '$i_kerja_jabatan'");
				$rjbtx = mysqli_fetch_assoc($qjbtx);
				...
				if ($tcc != 0)
					{
					//update
					mysqli_query($koneksi, "UPDATE m_pegawai SET usernamex = '$i_pegawai_nip', ".
									"passwordx = '$i_pass', ".
									"nip = '$i_pegawai_nip', ".
									"nuptk = '$i_nuptk', ".
									"nama = '$i_nama', ".
				...
				//jika blm ada, insert
					...
					{
					//insert
					mysqli_query($koneksi, "INSERT INTO m_pegawai(kd, usernamex, passwordx, nip, nuptk, nama, ".
				...
				//m_pegawai_keluarga ////////////////////////////////////////////////////////////////////////////////////////////////////
				$qcc = mysqli_query($koneksi, "SELECT * FROM m_pegawai_keluarga ".
				...
				if ($tcc != 0)
					{
					//update
					mysqli_query($koneksi, "UPDATE m_pegawai_keluarga SET status_kawin = '$i_status', ".
					...
					{
					//insert
					mysqli_query($koneksi, "INSERT INTO m_pegawai_keluarga (kd, kd_pegawai, status_kawin, tgl_nikah, ".
				...
				$qcc = mysqli_query($koneksi, "SELECT * FROM m_pegawai_pendidikan ".
										"WHERE kd_pegawai = '$cc_kd'");
				$rcc = mysqli_fetch_assoc($qcc);
				$tcc = mysqli_num_rows($qcc);
				...
				if ($tcc != 0)
					{
					//update
					mysqli_query($koneksi, "UPDATE m_pegawai_pendidikan SET kd_ijazah = '$i_pddkn_ijazah', ".
					...
					{
					//insert
					mysqli_query($koneksi, "INSERT INTO m_pegawai_pendidikan (kd, kd_pegawai, kd_ijazah, kd_akta, thn_lulus, ".
				...
				//cek
				$qcc = mysqli_query($koneksi, "SELECT * FROM m_pegawai_diklat ".
										"WHERE kd_pegawai = '$cc_kd'");
				$rcc = mysqli_fetch_assoc($qcc);
				$tcc = mysqli_num_rows($qcc);
				...
				if ($tcc != 0)
					{
					//update
					mysqli_query($koneksi, "UPDATE m_pegawai_diklat SET nama = '$i_kursus_nama', ".
					...
					{
					//insert
					mysqli_query($koneksi, "INSERT INTO m_pegawai_diklat (kd, kd_pegawai, nama, penyelenggara, tempat, ".
									"tahun, lama) VALUES ".
				...
				//m_pegawai_pekerjaan ///////////////////////////////////////////////////////////////////////////////////////////////////
				$qcc = mysqli_query($koneksi, "SELECT * FROM m_pegawai_pekerjaan ".
										"WHERE kd_pegawai = '$cc_kd'");
				$rcc = mysqli_fetch_assoc($qcc);
				$tcc = mysqli_num_rows($qcc);
				...
				if ($tcc != 0)
					{
					//update
					mysqli_query($koneksi, "UPDATE m_pegawai_pekerjaan SET kd_status = '$i_pegawai_status', ".
					...
					{
					//insert
					mysqli_query($koneksi, "INSERT INTO m_pegawai_pekerjaan (kd, kd_pegawai, kd_status, kd_golongan, ".
