...
if (empty($tapelkd))
	...
	{
	//query
	$q = mysqli_query($koneksi, "SELECT m_prog_pddkn_kelas.*, m_prog_pddkn.*, m_prog_pddkn.kd AS mmkd ".
	...
	if ($total != 0)
		...
		do {
			...
			//guru-nya
			$quru = mysqli_query($koneksi, "SELECT m_pegawai.*, m_pegawai.kd AS mpkd, m_guru.*, m_guru_prog_pddkn.*, ".
