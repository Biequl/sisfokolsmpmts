	...
	do
		...
		do
			...
			if ($i_nourut == "01")
				{
				//jumlah 
				$qyuk21 = mysqli_query($koneksi, "SELECT kd, ket FROM sekolah_kib_a ".
			...
			//jika kib-b
				...
				//ket 
				$qyuk21 = mysqli_query($koneksi, "SELECT ket FROM sekolah_kib_b ".
													"WHERE sekolah_kd = '$sekkd83_session' ".
													"AND barang_kode LIKE '$kodeku%'");
				$ryuk21 = mysqli_fetch_assoc($qyuk21);
				$j_ket = balikin($ryuk21['ket']);
			...
			//jika kib-c
				...
				//jumlah 
				$qyuk21 = mysqli_query($koneksi, "SELECT kd, ket FROM sekolah_kib_c ".
													"WHERE sekolah_kd = '$sekkd83_session' ".
													"AND barang_kode LIKE '$kodeku%'");
				$ryuk21 = mysqli_fetch_assoc($qyuk21);
				$tyuk21 = mysqli_num_rows($qyuk21);
			...
			//jika kib-d
				...
				//jumlah 
				$qyuk21 = mysqli_query($koneksi, "SELECT kd, ket FROM sekolah_kib_d ".
													"WHERE sekolah_kd = '$sekkd83_session' ".
													"AND barang_kode LIKE '$kodeku%'");
				$ryuk21 = mysqli_fetch_assoc($qyuk21);
				$tyuk21 = mysqli_num_rows($qyuk21);
			...
			//jika kib-e
				...
				if ($j_bidang == "17")
					{
					//jumlah 
					$qyuk21 = mysqli_query($koneksi, "SELECT kd, ket FROM sekolah_kib_e ".
														"WHERE sekolah_kd = '$sekkd83_session' ".
														"AND buku_judul <> '' ".
														"AND barang_kode LIKE '$kodeku%'");
					$ryuk21 = mysqli_fetch_assoc($qyuk21);
			...
			//jika kib-f
				...
				{
				//jumlah 
				$qyuk21 = mysqli_query($koneksi, "SELECT kd, ket FROM sekolah_kib_f ".
													"WHERE sekolah_kd = '$sekkd83_session'");
				$ryuk21 = mysqli_fetch_assoc($qyuk21);
				$tyuk21 = mysqli_num_rows($qyuk21);
				$j_ket = balikin($ryuk21['ket']);
